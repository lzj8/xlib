...
public abstract class ImageWorker {
	...
	public void loadImage(Object data, ImageView imageView) {
		...
		if (bitmap != null) {
			...
			// change by lzj, we need the loading image to show as background
			// instead of imagesource
	...
	public void setLoadingImage(Bitmap bitmap) {
		mLoadingDrawableBg = new BitmapDrawable(mResources, bitmap);
	}
	...
	public void setLoadingImage(int resId) {
		mLoadingDrawableBg = mResources.getDrawable(resId);
	}

	public void setLoadingDrawable(Drawable drawable) {
		mLoadingDrawableBg = drawable;
	}
	...
	// because that we haven't a fragmentManager so use this method to
	// initialize the worker
	public void setImageCache(ImageCache imageCache, boolean initial) {
	...
	public static void cancelWork(ImageView imageView) {
		...
		if (bitmapWorkerTask != null) {
			...
			if (BuildConfig.DEBUG) {
				...
				XLog.d(TAG, "cancelWork - cancelled work for " + bitmapData);
			}
		}
	}
	...
	public static boolean cancelPotentialWork(Object data, ImageView imageView) {
		...
		if (bitmapWorkerTask != null) {
			...
			if (bitmapData == null || !bitmapData.equals(data)) {
				...
				XLog.d(TAG, "cancelPotentialWork - cancelled work for " + data);
	...
	private class BitmapWorkerTask extends AsyncTask<Object, Void, Bitmap> {
		...
		protected Bitmap doInBackground(Object... params) {
			...
			XLog.d(TAG, "doInBackground - starting work");
			...
			XLog.d(TAG, "doInBackground - finished work");
			return bitmap;
		}
		...
		protected void onPostExecute(Bitmap bitmap) {
			...
			if (bitmap != null && imageView != null) {
				XLog.d(TAG, "onPostExecute - setting bitmap");
	...
	private void setImageBitmap(ImageView imageView, Bitmap bitmap) {
		// TODO
		// ZoomWebImageView不支持设置setImageDrawable(),需要更好的方式来fix这个bug
		if (mFadeInBitmap && !(imageView instanceof ZoomWebImageView)) {
